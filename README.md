...
Once the `conda-forge` channel has been enabled, `pyvkfft` can be installed with:

```
conda install pyvkfft
```

It is possible to list all of the versions of `pyvkfft` available on your platform with:
